...
- (IBAction)customIOS7dialogButtonTouchUpInside:(id)sender
{
    ...
    if (delegate != NULL) {
        [delegate customIOS7dialogButtonTouchUpInside:self clickedButtonAtIndex:senderView.tag];
        [self close];
    }

    if (onButtonTouchUpInside != NULL) {
        onButtonTouchUpInside(self, senderView.tag);
    }
}
...
//    [dialogContainer.layer insertSublayer:gradient atIndex:0];
    ...
    UIColor* grayColor = [UIColor colorWithRed:198.0/255.0 green:198.0/255.0 blue:198.0/255.0 alpha:1.0f];
    ...
    if ([buttonTitles count] == 2) {
        ...
        verticalLine.frame = CGRectMake(lineView.frame.size.width/2., lineView.frame.origin.y, kCustomIOS7AlertViewDefaultButtonSpacerHeight, dialogContainer.frame.size.height - lineView.frame.origin.y);
        verticalLine.backgroundColor = grayColor;
        
        [dialogContainer addSubview:verticalLine];
    }
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton setTitleColor:[Design textColorBlue] forState:UIControlStateNormal]; //[UIColor colorWithRed:0.0f green:0.5f blue:1.0f alpha:1.0f]
        [closeButton setTitleColor:[Design textColorBlue] forState:UIControlStateHighlighted]; //[UIColor colorWithRed:0.2f green:0.2f blue:0.2f alpha:0.5f]
